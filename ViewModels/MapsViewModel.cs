...
public partial class MapsViewModel(INavigationService navigation, IFlickrApiService flickr) : ObservableObject
{
    public ObservableCollection<WonderLocation> Wonders { get; } = new()
    {
    ...
    private async Task LoadItemsAsync(double latitude, double longitude)
    {
        ...
        foreach (var photo in Photos)
        {
            ...
            Debug.WriteLine(photo.SmallUrl);
        }
    }
